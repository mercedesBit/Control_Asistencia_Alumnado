        ...
        <div class="col-lg-6">
            ...
            <form action="EstudianteServlet?tipo=edit" method="post">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" type="text" name="txtTutorID" value="<%=(estudiante != null && estudiante.getTutor() != null)? estudiante.getTutor().getTutorID():""%>">
                </div>

                <br>
                <div class="button">
                    <input class="btn btn-primary" type="submit" value="Actualizar">
                    <a class="btn btn-primary" href="EstudianteServlet?tipo=list">Regresar Listado</a>
                </div>
